...
<h2>Hello World!</h2>
    <form action="/Dynamic/insertOneDynamic.do" method="post" enctype="multipart/form-data" >
        <%--<input type="text" name="dynamic_id" value="14">--%>
            ...
            <input type="text" name="little_introduce" value="">
            <%--<input type="text" name="agriculture_view" value="" placeholder="agriculture_view">--%>
    ...
    <form action="/test/hello.do" method="get">
        <input type="text" name="user_id_f">
        <input type="submit" value="hello">
    </form>
</body>
</html>
